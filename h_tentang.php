...
<html lang="en">
  ...
  <header>
    ...
    <div class="container">
      ...
      <h1 class="my-4">Tentang Kampung Sholawat </h1>
          
              <a href="#"><img class="card-img-top" src="foto/ks.jpg" alt=""></a>
        <br><br>
          <p>Merupakan Media dakwah & Informasi tentang islam yang Rahmatan lil 'alamin serta menjadi sarana berbagi informasi antar sesama muslim.
              Web Kampung Sholawat ini di harapkan menjadi oase di dunia internet yang kita ketahui bersama jangkauannya melewati batas geografis suatu daerah.
              Kampung Sholawat Naqsyabandi Nazhimiyah Center
              Selain itu Kampung Sholawat merupakan nama dari sebuah Zawiyah di Caruban kab.madiun jawa timur yang mana merupakan tempat tinggal dari Guru Kami Syaikh Mustafa Mas'ud ,di mana rutin setiap bulan di adakan majlis SULUK SABTU PAHING.
